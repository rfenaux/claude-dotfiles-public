...
**Use Case 5: Build investment justification deck using <PROJECT>-style ROI framing**
...
- "Build investment justification deck using <PROJECT>-style ROI framing."
...
|-------|---------------------|
| `<REMOVED>` | <PROJECT>-specific ROI modeling |
