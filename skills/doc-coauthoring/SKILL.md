...
## RAG Integration (Check First)

**Before starting any documentation task:**

1. **Check RAG availability**: Does `.rag/` folder exist in the project?
2. **If RAG available**, search for relevant context:
   - Past similar documents or templates
   - Project decisions (DECISIONS.md)
   - Related meeting notes or transcripts
   - Existing documentation patterns
3. **Use RAG results** to inform document structure and content
4. **Cite RAG sources** where applicable

**RAG Search Queries for Documentation:**
- "template" + document type (e.g., "decision doc template")
- "previous" + document type (e.g., "previous technical spec")
- Topic-specific queries based on document subject
- "style guide" or "documentation standards"
...
```markdown
# [Feature/System Name] Technical Spec
...
**If outside scope:**
- State: "This task requires [other skill/agent]"
- Suggest: "Would you like me to switch to [skill]?"

**NEVER:**
- Proceed silently with assumptions
- Hallucinate content or requirements
