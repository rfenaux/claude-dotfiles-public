...
| `commercial-analyst-cognita.md` | Cognita project archived | `mv ~/.claude/agents/_archived/commercial-analyst-cognita.md ~/.claude/agents/` |
| `document-navigator-cognita.md` | Cognita project archived | `mv ~/.claude/agents/_archived/document-navigator-cognita.md ~/.claude/agents/` |
| `regional-comparator-cognita.md` | Cognita project archived | `mv ~/.claude/agents/_archived/regional-comparator-cognita.md ~/.claude/agents/` |
| `risk-analyst-cognita.md` | Cognita project archived | `mv ~/.claude/agents/_archived/risk-analyst-cognita.md ~/.claude/agents/` |

### P1: Slimmed & Consolidated Agents

#### solarc-agent (32KB → 2KB)

**Backup location:** `~/.claude/agents/solarc-agent-ignore-and-do-not-rag-index.md`

**Rollback:**
```bash
mv ~/.claude/agents/solarc-agent.md ~/.claude/agents/solarc-agent-SLIM.md
mv ~/.claude/agents/solarc-agent-ignore-and-do-not-rag-index.md ~/.claude/agents/solarc-agent.md
```
